                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
								<form method="post" action="rezolvaquest.php">
				...
				<?php
				 ...
				 $query = "SELECT * FROM quests";
						...
						while ($row = mysqli_fetch_array($result)) {
							...
							$title = $row['title'];
							$points_rewarded = $row['points_rewarded'];
						?>
					...
					<tr>
									<td><?php echo $id_quest; ?></td>
									<td><?php echo $title; ?></td>
									<td><?php echo $description; ?></td>
									<td><?php echo $points_rewarded; ?></td>
									<td>
										<input type="radio" name="selected_quest_id" value="<?php echo $id_quest; ?>" />
									</td>
								</tr>
							<?php
								...
								<input type="submit" name="submit1" value="Rezolva Quest" />
								<br> <br>
								<?php
